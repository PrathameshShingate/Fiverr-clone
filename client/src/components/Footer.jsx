...
const Footer = () => {
  return (
    <div className="footer flex justify-center pt-16 pb-6 bg-[#fffcfc]">
      <div className="max-w-[1440px] w-full px-8">
        <div className="flex justify-between">
          <div className="flex flex-col gap-4">
            <h2 className="text-[#404145] font-bold">Categories</h2>
            <Link to="/" className="text-[#74767e] font-medium hover:underline">
              Graphics & Design
            </Link>
            <Link to="/" className="text-[#74767e] font-medium hover:underline">
              Digital Marketing
        ...
        <hr className="w-full h-0 border-px border-[#ebe9e9] mt-10 mb-6" />
        <div className="flex justify-between">
          <div className="flex items-center gap-6">
            ...
            <span className="text-[#bfbbbb] text-sm font-medium">
          ...
          <div className="flex items-center gap-10">
            ...
            <div className="flex items-center gap-5">
              <span className="flex items-center gap-2 text-[#74767e] text-sm font-semibold">
                <svg
                  width="18"
                  height="18"
                  viewBox="0 0 18 18"
              ...
              <span className="font-semibold text-[#74767e] text-sm">INR</span>
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
